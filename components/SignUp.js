...
class SignUpCom extends React.Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            DetailsUser_Array: [{
                ...
                job_seeker_email_id: "",
                job_seeker_password: "",
                job_seeker_gender: "Male",
                job_seeker_mobile_code: "",
                job_seeker_mobile_number: "",
                // job_seeker_age: "",
                job_seeker_dob: "",

                job_seeker_job_type: "Part-Time",
                job_seeker_job_type_time: "Day",
                job_seeker_current_employer: "",
                job_seeker_location: "",

                job_seeker_industry_type: "Restaurant",
                job_seeker_jt_restaurant_cat: "",
                job_seeker_type_of_food_served: "",

                job_seeker_experience_Month: "",
                job_seeker_experience_years: "",
                job_seeker_current_work_location: "",
                job_seeker_language_known_speak: "",
                job_seeker_language_known_write: "",
                job_seeker_skill: "",
                job_seeker_educational_qualification: "",

                distance_from_home: "",
                job_seeker_additional_information: "",
                job_seeker_carrier_objective: "",
                preferred_work_region: "",

                job_seeker_city: "",
                job_seeker_country_name: "",
                job_seeker_state_name: "",

            }],//JSON.parse(JSON.stringify(this.props.appdata.userDetails)),
            ...
            Skill_Array: this.props.appdata.Skills_Array,
            EDQualification_Array: this.props.appdata.Qualification_Array,
            isMultiSelectPopUpOpen: false,
            isFoodsMultiSelectPopUpOpen: false,
            isLanguageKnownSpeakMultiSelectPopUpOpen: false,
            isLanguageKnownWriteMultiSelectPopUpOpen: false,
        ...
        SQLite.openDatabase({
            ...
            db.transaction((tx) => {
                ...
                if (this.state.DetailsUser_Array[0].job_seeker_country_name.trim() != "") {
                ...
                if (this.state.DetailsUser_Array[0].job_seeker_state_name.trim() != "") {
                ...
                if (this.state.DetailsUser_Array[0].job_seeker_city.trim() != "") {
    ...
    async post_ProfileData() {
        ...
        postData.append('job_seeker_password', this.state.DetailsUser_Array[0].job_seeker_password.trim());
        ...
        if (this.isEmptyObj(this.state.CV_Upload_Path)) {
            postData.append('job_seeker_upload_resume', '');
        } else {
            postData.append('job_seeker_upload_resume', {
                uri: this.state.CV_Upload_Path.uri,
                type: this.state.CV_Upload_Path.type,
                name: this.state.CV_Upload_Path.fileName,
                data: this.state.CV_Upload_Path.data
            });
        }

        // console.log('postData :- ', JSON.stringify(postData));

        const response = await fetch("http://ijobs.shop/webservice/candidateregister.php?root=register", {
            headers: {
    ...
    SaveProfileData = () => {
        ...
        } else if (this.state.DetailsUser_Array[0].job_seeker_password.trim() == "") {
        ...
        } else if (this.isEmptyObj(this.state.CV_Upload_Path)) {
            Alert.alert('Warning', 'Please select resume.')
        ...
        this.post_ProfileData()
            ...
            .then((data) => {
                ...
                if (parseInt(data.success) == 1) {
                    ...
                    // Alert.alert('Success', data.MessageDetails);
                    Alert.alert(
                        'Success',
                        data.MessageDetails,
                        [
                    ...
                    Alert.alert('Warning', data.MessageDetails)
                                ...
                                <KeyboardAvoidingView style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', }}
                                    ...
                                    <ScrollView style={{ flex: 1 }}
                                        ...
                                        <View style={{ flex: 1, alignItems: 'center', margin: 10, }}>
                                            <TouchableOpacity style={{ alignItems: 'center', }} onPress={() => this.openPhotoGalaryOrCamera(1)}>
                                        ...
                                        <View style={styles.View_Box}>
                                            ...
                                            <View style={[styles.gridItem]}>
                                                <Text style={styles.Lbl_Grid}>Password: </Text>
                                                <View style={styles.View_Box_TextField}>
                                                    <TextInput
                                                        style={styles.TextInput_ShareText}
                                                        ...
                                                        onChangeText={text => {
                                                            const newArray = [...this.state.DetailsUser_Array];
                                                            newArray[0].job_seeker_password = text;
                                                            this.setState({ DetailsUser_Array: newArray });
                                                        }}
                                                        value={this.state.DetailsUser_Array[0].job_seeker_password}
                                                    />
                                                </View>
                                            </View>
                                        ...
                                        <View style={styles.View_Box}>
                                            ...
                                            <View style={[styles.gridItem]} >
                                                <Text style={styles.Lbl_Grid}>Upload Resume: </Text>
                                                <TouchableOpacity style={styles.View_Box_TextField} onPress={() => this.openPhotoGalaryOrCamera(2)} >
                                                    <Text style={!this.isEmptyObj(this.state.CV_Upload_Path) ? [styles.Lbl_ShareText] : [styles.Lbl_ShareText, styles.Lbl_PlaceHolder_Color]}>
                                                        {!this.isEmptyObj(this.state.CV_Upload_Path) ? this.state.CV_Upload_Path.fileName : 'Select file'}
                                                    </Text>
                                                    <Image
                                                        source={require('../images/cameraIcon.png')}
                                                        style={{ width: 25, height: 25, margin: 5, alignSelf: 'center' }}
